...
summary: "Breaking down the six retrieval metrics that drive every experiment in this project: Hits@k, FactRecall, AllGold, MRR, and MAP, and why verbatim gold facts scraped directly from the source articles make fully reproducible, LLM-free evaluation possible."
---
