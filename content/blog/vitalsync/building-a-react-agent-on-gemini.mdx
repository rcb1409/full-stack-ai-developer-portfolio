...
date: "2026-03-18"
project: "vitalsync"
summary: "How I wired up a 4-tool ReAct loop on Gemini 2.5 Flash, built a classifier that separates semantic errors from system failures to avoid retry storms, and put together an LLM-as-judge eval suite that caught regressions before users ever saw them."
---
